# Will decide to use the jupiter colab notebook for this script instead of google shell
...
df_op = pd.read_csv('/home/rianne_bonitto/flask_e2e_project/data/Medicare_Part_D_Opioid_Prescribing_Rates_by_Geography_2021.csv')
...
#export to csv
merged.to_csv('/home/rianne_bonitto/flask_e2e_project/data/drug_spendingclean_geolocation.csv')
...
#Create map of Opioid Prescribing Rate
...
merged_map['geometry'] = gpd.GeoSeries.from_wkt(merged_map['geometry'])
my_geo_df = gpd.GeoDataFrame(merged_map, geometry='geometry')
